...
const Button = ({ variant = 'full', children, ...otherProps }) => {
  const buttonClasses = {
    ...
    logout: 'font-semibold px-3 backdrop:blur-md hover:backdrop:blur-lg py-1 hover:transparent text-red-500 border-red-500 border-2 hover:bg-red-100 ease-in-out rounded-md transition-all cursor-pointer',
  };
